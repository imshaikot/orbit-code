...
// Pure and deterministic: the host runs it for live updates (@orbit-code/core), and tools/harness/src/hostSim.ts in the harness.

import type { LayoutSnapshot, NodeColumns } from '@orbit-code/protocol';
