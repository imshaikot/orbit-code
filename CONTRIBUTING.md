...
Thanks for taking the time. Orbit Code brings open-source, live 3D visuals to Claude Code, in VS Code, as a desktop app and as a web client: it draws a workspace as a 3D dependency graph and animates a Claude Code session moving through it. Bug reports, imports your language is missing, docs fixes and code are all welcome.
