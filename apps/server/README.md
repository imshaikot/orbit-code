...
The local server for [Orbit Code](https://orbit-code.imshaikot.com) ([source](https://github.com/imshaikot/orbit-code)), which draws a workspace as a live 3D dependency graph and animates a Claude Code session moving through it.
...
> **Early.** This version reports its version and nothing more; serving a workspace is tracked in [issue #2](https://github.com/imshaikot/orbit-code/issues/2). For Orbit today, use the VS Code extension or the desktop app: the [install guide](https://orbit-code.imshaikot.com/install/) has both.
