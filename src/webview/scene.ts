import { FILE_KINDS, FILE_KIND_LABELS, type FileKind, fileKindOf } from '../shared/languages';
import type { ActivityDelta, GraphContent, GraphDelta, GraphUpdate } from '../shared/protocol';
